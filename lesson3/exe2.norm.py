...
data = input()
data1 = data.split('.')
dict_d = {'01': 'первое', '02': 'второе', '03': 'третье', '04': 'четвёртое', '05': 'пятое',
...
dict_m = {'01': 'января', '02': 'февраля', '03': 'марта', '04': 'апреля', '05': 'мая', '06': 'июня', '07': 'июля', '08': 'августа', '09': 'сентября', '10': 'октября', '11': 'ноября', '12': 'декабря'}
for i in dict_d:
    if data1[0] == i:
        data1[0] = dict_d[i]
for i in dict_m:
    if data1[1] == i:
        data1[1] = dict_m[i]
print(data1[0], data1[1], data1[2], 'года.')
